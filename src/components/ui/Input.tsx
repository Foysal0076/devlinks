      ...
      <div
        ...
        <div className='relative flex flex-col'>
          <input
            ...
            {...inputParams}
            className={cn(
              'rounded-lg border-none px-4 text-neutral-600 outline-none ring-1 placeholder:text-neutral-100 focus:placeholder:text-primary-100 disabled:bg-neutral-30 disabled:text-neutral-100 dark:bg-neutral-800 dark:text-neutral-50 dark:disabled:bg-neutral-400',
              {
